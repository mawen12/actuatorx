...
func (a *ActuatorApi) Abilities(c *gin.Context, cli *client2.Client) (interface{}, error) {
	return cli.Abilities(), nil
}

func (a *ActuatorApi) GetHealth(c *gin.Context, cli *client2.Client) (interface{}, error) {
	return cli.Health(c.Request.Context())
}

func (a *ActuatorApi) GetMetrics(c *gin.Context, cli *client2.Client) (interface{}, error) {
	return cli.Metrics(c.Request.Context())
}

func (a *ActuatorApi) GetMetric(c *gin.Context, cli *client2.Client) (interface{}, error) {
	name := c.Param("name")
	if name == "" {
...
func (a *ActuatorApi) GetEnv(c *gin.Context, cli *client2.Client) (interface{}, error) {
	return cli.Env(c.Request.Context())
}

func (a *ActuatorApi) GetBeans(c *gin.Context, cli *client2.Client) (interface{}, error) {
	return cli.Beans(c.Request.Context())
}

func (a *ActuatorApi) GetConditions(c *gin.Context, cli *client2.Client) (interface{}, error) {
	return cli.Conditions(c.Request.Context())
}

func (a *ActuatorApi) GetConfigprops(c *gin.Context, cli *client2.Client) (interface{}, error) {
	return cli.Configprops(c.Request.Context())
}

func (a *ActuatorApi) GetCaches(c *gin.Context, cli *client2.Client) (interface{}, error) {
	return cli.Caches(c.Request.Context())
}

func (a *ActuatorApi) EvictAllCaches(c *gin.Context, cli *client2.Client) (interface{}, error) {
	err := cli.EvictAllCaches(c.Request.Context())
	return nil, err
}

func (a *ActuatorApi) EvictCache(c *gin.Context, cli *client2.Client) (interface{}, error) {
...
func (a *ActuatorApi) GetLoggers(c *gin.Context, cli *client2.Client) (interface{}, error) {
	return cli.Loggers(c.Request.Context())
}

func (a *ActuatorApi) SetLoggerLevel(c *gin.Context, cli *client2.Client) (interface{}, error) {
...
func (a *ActuatorApi) GetMappings(c *gin.Context, cli *client2.Client) (interface{}, error) {
	return cli.Mappings(c.Request.Context())
}

func (a *ActuatorApi) GetHttpExchanges(c *gin.Context, cli *client2.Client) (interface{}, error) {
	return cli.HttpExchanges(c.Request.Context())
}

func (a *ActuatorApi) GetLogfile(c *gin.Context, cli *client2.Client) (interface{}, error) {
...
func (a *ActuatorApi) GetScheduledTasks(c *gin.Context, cli *client2.Client) (interface{}, error) {
	return cli.ScheduledTasks(c.Request.Context())
}

func (a *ActuatorApi) GetTogglz(c *gin.Context, cli *client2.Client) (interface{}, error) {
	return cli.Togglz(c.Request.Context())
}

func (a *ActuatorApi) UpdateTogglz(c *gin.Context, cli *client2.Client) (interface{}, error) {
...
func (a *ActuatorApi) GetThreadDump(c *gin.Context, cli *client2.Client) (interface{}, error) {
	return cli.ThreadDump(c.Request.Context())
}

func (a *ActuatorApi) DownloadThreadDump(c *gin.Context, cli *client2.Client) (interface{}, error) {
	return cli.DownloadThreadDump(c.Request.Context())
}

func (a *ActuatorApi) wrap(handler func(c *gin.Context, cli *client2.Client) (data interface{}, err error)) gin.HandlerFunc {
...
func (a *ActuatorApi) resource(c *gin.Context) (*client2.Resource, error) {
	urlStr := c.Query("url")
