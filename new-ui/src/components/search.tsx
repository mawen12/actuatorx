...
export function Search({
  ...
  return (
    ...
    >
      ...
      <kbd className='pointer-events-none absolute inset-e-[0.3rem] hidden items-center gap-1 rounded border bg-muted px-1.5 font-mono font-medium opacity-100 select-none group-hover:bg-accent sm:flex'>
